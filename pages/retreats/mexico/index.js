        ...
        <div className="row text-center align-items-center lowBright">
          ...
          <div className="col-lg-5 px-5 py-lg-5 pb-5 text-center">
            <p className="my-0">
              ...
              have some practice of self care already in place. Join us us on
              this sacred rest experience to allow a deeper rest, and
              restorative reset. Letting in new light, blessed by nature, and
              connection with your highest self.
            </p>
          </div>
        </div>
      </div>
