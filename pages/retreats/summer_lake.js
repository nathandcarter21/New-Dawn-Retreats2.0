				...
				<div className="row text-center align-items-center lowBright contourBtm">
					...
					<div className="col-lg-5 px-5 py-lg-5 pb-5 text-centered">
						<p className="my-0">
							...
							will offer the opportunity to experience sacred rest within sacred
							space together.
						</p>
					</div>
				</div>
				...
				<div className="row text-center align-items-center contourBtm">
					...
					<div className="col-lg-5 px-5 py-lg-5 pb-5 text-center order-2 order-lg-1">
						<p className="my-0">
							...
							cleansing, and healing offerings *You are welcome to bring a
							musical instrument or offering that would enrich these honored
							practices. A delicious meal will be provided nightly and shared
							together at the Healing house followed by a fire ceremony. //more
						</p>
					</div>
				</div>
